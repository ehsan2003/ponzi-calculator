...
export const data: ProjectDefinitionServer[] = [
	{
		...
		onWebamooz: [
			{ url: 'https://t.me/webamoozir/14084' },
			{ url: 'https://t.me/webamoozir/14082' }
		],
		victimCountEstimate: 'یک میلیون نفر',
		dailyBonus: 1.031820580257143,
		bonusText: 'ماهیانه ۱۰ درصد',
		links: [
			{ name: 'سایت یونیک فایننس', url: 'https://test.com' },
			{ name: 'سایت یونیک فایننس', archive: 'https://test.com' },
			{ name: 'مهم ترین لینک عالم', archive: 'https://archive.org', url: 'https://twitter.com' }
		],
		slug: 'testponzi' + ++i,
